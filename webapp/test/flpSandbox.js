		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demodocumenttranslation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demodocumenttranslation-display": {
								"semanticObject": "demodocumenttranslation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.documenttranslation",
									"url": sap.ui.require.toUrl("demo/documenttranslation")
								}
							}
						}
					}
